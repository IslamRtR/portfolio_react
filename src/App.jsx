...
const translations = {
  en: {
    ...
    nav_contact: 'Contact',
    welcome_hello: 'Hello!',
    welcome_title: 'I\'m Islam Gabbas',
    ...
    footer_copyright: '© 2023 Islam Gabbas. All rights reserved.'
  },
  ru: {
    nav_home: 'Главная',
    nav_about: 'Обо мне',
    ...
    footer_copyright: '© 2023 Ислам Габбас. Все права защищены.'
  }
};
...
const certificateData = {
  ...
  'Meta-Front-End-Developer': { image: '/Meta-Front-End-Developer.png public/Meta Front-End Developer.png' }
};
  ...
  return (
    <header>
      ...
      <div className="social-icons">
        <a href="https://github.com/IslamRtR" target="_blank" rel="noopener noreferrer"><i className="fab fa-github"></i></a>
        <a href="https://www.linkedin.com/in/islam-gabbas-51464835b/" target="_blank" rel="noopener noreferrer"><i className="fab fa-linkedin"></i></a>
        <a href="https://t.me/isagls" target="_blank" rel="noopener noreferrer"><i className="fab fa-telegram"></i></a>
      </div>
...
const Welcome = ({ lang }) => (
  <section id="home" className="welcome">
    ...
    <img src="/gpt.png" alt="Profile Image" className="profile-img" />
  </section>
);

const About = ({ lang }) => (
  <section id="about" className="about">
    <img src="/logo.png" alt="About Image" className="about-img" />
      ...
      <div className="myDate">
        <div className="date">
          ...
          <div className="right-side">
            ...
            <h3><a href="https://t.me/isagls" target="_blank" rel="noopener noreferrer">@isagls</a></h3>
          </div>
        </div>
        <div className="stats">
        ...
        <div className="dateButtons">
          <a href="https://drive.google.com/file/d/1uW5i5i5i5i5i5i5i5и5и5и5и5и5/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="checkProjects">{translations[lang].about_download_cv}</a>
          <a href="https://github.com/IslamRtR?tab=repositories" target="_blank" rel="noopener noreferrer" className="checkCertificate">{translations[lang].about_my_projects}</a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div className="contact-container">
        <div className="contact-info">
          {[
            ...
            { icon: 'fas fa-envelope', title: translations[lang].contact_email, content: 'islamgabbas@gmail.com' },
    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="/resume" element={<ResumePage lang={lang} openModal={openModal} />} />
